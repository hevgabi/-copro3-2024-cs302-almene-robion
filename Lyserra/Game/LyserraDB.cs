...
namespace Lyserra.Game
{
    public static class LyserraDB
    {
        ...
        public static void insertPet(Pet pet)
        {
            ...
            {
                conn.Open();
                string sql = @"INSERT INTO Pet (masterID, petName, weight, age, breed, hairColor, colorDesign, hairCut, eyeColor, accessory, personality, scent, mutation, element, crystal, evolution)
